...
const someImages = [
  {
    ...
    title: ['國際生活排場', '✦'],
    subTitle: ['新北第一國際城', '林口與世界無縫接軌'],
    article: ['機捷X中山高最強交通！高科技聚落迅速發展，願景無限！']
  },
  {
    ...
    title: [''],
    subTitle: ['媒體三大巨擘齊聚', '300億資金重磅進駐'],
    article: [
      '三立集團＋東森集團＋日商三井媒體集團合力打造',
      '【全台最高國際媒體園區】創造1.5萬就業機會，',
      '人潮帶來錢潮，匯聚影視媒體菁英新貴！',
  ...
  },
  {
    ...
    title: ['三發地產真工藝', '大師陣容傾心打造', '✦'],
    subTitle: ['三發地產精工藝．締造好宅輝煌史', '三發地產企業六大堅持'],
    article: [
      '音樂文創',
    ...
    <Layout className="wrapper-app">
      <Content className="site-layout" id={1}>
        ...
        <div className="image">
          ...
          {someImages.map(
            ({ leftImages, rightImages, title, subTitle, article }) => (
              <div key={uuidv4()}>
                <Row>
